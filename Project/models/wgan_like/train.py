...
from models.wgan_like.critic import Critic
from models.wgan_like.generator import Generator
from models.wgan_like.criterion import WCriticLoss, WGeneratorLoss
from models.wgan_like.wgan_loss_gradient_penalty import gradient_penalty
    ...
    for _ in range(config['num_epochs']):
        ...
        with tqdm(loader, desc='Train', bar_format=BAR_FORMAT) as tqdm_loader:
            for i, (original, corrupted, labels) in enumerate(tqdm_loader):
                ...
                critic_epoch_loss += critic_loss.item() * labels.size(0)
